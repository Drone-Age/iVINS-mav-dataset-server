...
class ServerTest(unittest.TestCase):
    ...
    def test_health_is_minimal_and_all_v1_reads_require_a_key(self):
        ...
        self.assertEqual("4.0.0", health.json["server_version"])
        ...
        self.assertEqual("4.0.0", versions.json["backend"])
        self.assertEqual(
            ">=4.0.0 <5.0.0", versions.json["compatibility"]["frontend_requires_backend"]
        )
